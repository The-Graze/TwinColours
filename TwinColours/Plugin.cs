...
namespace TwinColours
{
    public class Plugin : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            PlayerColour1 = ColorUtility.TryParseHtmlString(_playerColour1.Value, out PlayerColour1) ? PlayerColour1 : Color.black;
            PlayerColour2 = ColorUtility.TryParseHtmlString(_playerColour2.Value, out PlayerColour2) ? PlayerColour2 : Color.black;
        }
