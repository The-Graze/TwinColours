    ...
    internal abstract class Patches
    {
        ...
        private class PauseMenuCustomizePatches
        {
            ...
            private static bool NewAwake(PauseMenuCustomize __instance)
            {
                ...
                _custom1 = Object.Instantiate(__instance.primaryButton.GetComponentsInChildren<MmColourButton>()[1], __instance.primaryButton.transform, true);
                _custom1.transform.localPosition += new Vector3(128,0,0);
                _custom2 = Object.Instantiate(__instance.secondaryButton.GetComponentsInChildren<MmColourButton>()[1], __instance.secondaryButton.transform, true);
                ...
                __instance._selected2 = Array.FindIndex<MmColourButton>(__instance._primaries, (button => button.colour == SaveData.save.primaryColour));
                if (__instance._selected2 == -1)
                {
                    __instance._selected2 = 0;
                }
                return false;
            }
        }
